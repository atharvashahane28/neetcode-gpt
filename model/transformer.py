...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.network = self.VanillaNeuralNetwork(model_dim)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        embedded += self.attention(embedded=self.layer_norm_1(embedded))
        embedded += self.network(x=self.layer_norm_2(embedded))
